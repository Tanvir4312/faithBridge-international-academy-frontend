...
interface MyProfile_TeacherProps {
    userInfo: any;
    roleData: any;
}

const MyProfile_Teacher = ({ userInfo, roleData }: MyProfile_TeacherProps) => {
        ...
        <div className="space-y-6">
            ...
            <div className="relative overflow-visible md:overflow-hidden bg-white/60 backdrop-blur-xl rounded-[2.5rem] shadow-2xl border border-white/30 p-6 sm:p-10">
                ...
                <div className="relative flex flex-col lg:flex-row items-center lg:items-end gap-8 sm:gap-10">
                    <div className="relative flex-shrink-0 mt-12 lg:mt-0">
                        <div className="w-32 h-32 sm:w-40 sm:h-40 lg:w-48 lg:h-48 rounded-[2.5rem] overflow-hidden border-4 border-white shadow-2xl bg-gray-100 flex items-center justify-center group relative ring-8 ring-white/10">
                            {profilePhoto ? (
            ...
            {(userInfo.status === "INACTIVE" || userInfo.status === "SUSPENDED") && (
                <div className="bg-rose-50 border-2 border-rose-200 p-8 rounded-[2.5rem] flex items-center gap-8 animate-pulse shadow-xl">
                    ...
                    <div>
                        <h3 className="text-rose-900 font-black uppercase tracking-[0.2em] text-sm">Faculty Access Suspended</h3>
                        <p className="text-rose-700 text-sm font-bold mt-2 leading-relaxed">
                            ...
                            Academic portal access and student management activities are locked. 
                            Please consult the school administration.
                        </p>
                    </div>
                </div>
            )}
                ...
                <div className="lg:col-span-4 space-y-6 sm:space-y-8">
                    <div className="bg-white/70 backdrop-blur-2xl p-6 sm:p-8 rounded-[2rem] border border-white shadow-xl hover:shadow-2xl transition-all duration-500">
                        ...
                        <div className="space-y-1">
                            <InfoItem icon={Briefcase} label="Professional Title" value={roleData?.designation || "Faculty Member"} />
                            <InfoItem icon={Clock} label="System Enrollment" value={joinDate} />
                            <InfoItem icon={Phone} label="Contact Terminal" value={roleData?.contactNumber || "N/A"} />
                        </div>
                    </div>
                ...
                <div className="lg:col-span-8 space-y-6 sm:space-y-8">
                    <div className="bg-white/70 backdrop-blur-2xl p-6 sm:p-10 rounded-[2rem] border border-white shadow-xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                            ...
                            <InfoItem icon={GraduationCap} label="Highest Qualification" value={roleData?.qualification || "N/A"} />
                        </div>
                    </div>
                    ...
                    <div className="bg-white/70 backdrop-blur-2xl p-6 sm:p-10 rounded-[2rem] border border-white shadow-xl">
                        ...
                        <div className="grid grid-cols-1 gap-10">
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-amber-600 mb-4 px-2 opacity-60">Professional Residence</p>
...
export default MyProfile_Teacher;
