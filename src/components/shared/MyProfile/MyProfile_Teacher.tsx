                    ...
                    <div className="flex-1 min-w-0 text-center lg:text-left space-y-4 w-full">
                        <div className="flex flex-col lg:flex-row lg:items-center gap-4 lg:gap-6">
                            ...
                            <div className="flex items-center gap-3 mx-auto lg:mx-0">
                                ...
                                <Button onClick={() => setIsUpdateModalOpen(true)} size="sm" variant="secondary" className="rounded-full font-black text-[10px] uppercase tracking-widest px-6 shadow-xl hover:scale-105 active:scale-95 transition-all">
